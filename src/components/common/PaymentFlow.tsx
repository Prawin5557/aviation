                ...
                {step === 'details' && (
                  ...
                  >
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-start space-x-3">
                      <AlertCircle className="h-5 w-5 text-blue-600 shrink-0 mt-0.5" />
                      <p className="text-sm text-blue-700">
                        <span className="font-bold">Payment Gateway:</span> Card details are used only to prefill checkout context.
                      </p>
                    </div>
                ...
                {step === 'payment' && (
                  ...
                  >
                    ...
                    <div className="bg-amber-50 border-2 border-amber-300 rounded-xl p-4 flex items-start space-x-3">
                      ...
                      <div>
                        <p className="text-sm font-bold text-amber-900">Review Before Paying</p>
                        <p className="text-xs text-amber-800 mt-1">Ensure your selected plan and billing amount are correct before checkout.</p>
                      </div>
                    </div>
