...
import { Plus, Edit2, Trash2, Lock, Unlock, X, RefreshCw, Search, Filter, BarChart3, TrendingUp, Shield, ShieldCheck, AlertCircle, Key, Clock, Activity, Settings2, Zap, UserCheck } from "lucide-react";
...
export default function AdminManagement() {
  ...
  const fetchAdmins = async () => {
    try {
      ...
      const mockAdmins: AdminUser[] = [
        { id: '1', name: 'Rajesh Gupta', email: 'rajesh@admin.com', role: 'prime', status: 'Active', permissions: ['manage_all', 'view_analytics', 'manage_admins'], lastActive: '2 mins ago', joinedAt: '2024-01-15', isPrime: true },
        { id: '2', name: 'Priya Sharma', email: 'priya@admin.com', role: 'admin', status: 'Active', permissions: ['manage_jobs', 'manage_students', 'view_reports'], lastActive: '1 hour ago', joinedAt: '2024-02-20', isPrime: false },
        { id: '3', name: 'Amit Kumar', email: 'amit@admin.com', role: 'admin', status: 'Active', permissions: ['manage_payments', 'manage_campaigns', 'view_reports'], lastActive: '5 mins ago', joinedAt: '2024-03-10', isPrime: false },
        { id: '4', name: 'Sarah Johnson', email: 'sarah@admin.com', role: 'moderator', status: 'Active', permissions: ['view_reports', 'manage_events'], lastActive: '30 mins ago', joinedAt: '2024-03-25', isPrime: false },
      ];
      const mockStats: AdminStats = {
        ...
        totalPermissions: 32,
        adminsByRole: [
          { role: 'Prime', count: 1, color: '#a855f7' },
          { role: 'Admin', count: 8, color: '#3b82f6' },
          { role: 'Moderator', count: 5, color: '#10b981' },
        ],
        activityTrend: [
          { week: 'Week 1', actions: 240 },
          { week: 'Week 2', actions: 380 },
          { week: 'Week 3', actions: 320 },
          { week: 'Week 4', actions: 450 },
          { week: 'Week 5', actions: 580 },
        ],
      };
  ...
  const permissionData = [
    { name: 'manage_jobs', count: 8 },
    { name: 'manage_students', count: 7 },
    { name: 'manage_payments', count: 5 },
    { name: 'view_reports', count: 11 },
  ];
